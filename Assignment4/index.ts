...
let x : number = 10, y : number = 20, z : number = 30; // Declaring three variables x, y, and z of type number and assigning them values 10, 20, and 30
    ...
    let year : number = 2020; // Declaring a variable year of type number and assigning it a value 2020
